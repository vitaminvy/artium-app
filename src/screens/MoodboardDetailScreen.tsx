...
export default function MoodboardDetailScreen() {
  ...
  const [items, setItems] = useState<Array<{ id: string; title: string; image?: string | null; price?: string | null }>>([]);
    ...
    <View className="flex-1 bg-white">
      ...
      {loading ? (
        ...
        <FlatList
          ...
          contentContainerStyle={{ padding: 16, paddingBottom: Math.max(insets.bottom + 40, 80) }}
          renderItem={({ item }) => (
