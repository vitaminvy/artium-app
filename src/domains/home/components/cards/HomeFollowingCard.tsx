...
function HomeFollowingCard({
  ...
  return (
    <Container
      className="flex-1 rounded-3xl bg-white border border-slate-100 px-3 pt-5 pb-6 items-center"
      style={cardShadow}
      onPress={() => onPress?.(item)}
    >
      <View style={cardContentStyle} className="items-center">
        ...
        <View className="mt-3 flex-row flex-wrap items-center justify-center">
          <Text
            className="text-[15px] font-semibold text-slate-900 text-center"
            style={nameTextStyle}
          >
            {item.name}
          </Text>
